...
- **Climate form layout bug** — Window label/dropdown encroaches on Handle/DID input on Firefox. Probably a flex-wrap or min-width issue. Low priority cosmetic fix.
